...
namespace MoviesAPI
{
    public class ApplicationDBContext : IdentityDbContext
    {
        ...
        {
            var adventure = new Genre() { Id = 8, Name = "Adventure" };
            ...
            var jimCarrey = new Person() { Id = 7, Name = "Jim Carrey", DateOfBirth = new DateTime(1962, 01, 17) };
            var robertDowney = new Person() { Id = 8, Name = "Robert Downey Jr.", DateOfBirth = new DateTime(1965, 4, 4) };
            var chrisEvans = new Person() { Id = 9, Name = "Chris Evans", DateOfBirth = new DateTime(1981, 06, 13) };
            ...
            modelBuilder.Entity<MoviesActors>().HasData(
                ...
                {
                    new MoviesActors(){MovieId = endgame.Id, PersonId = robertDowney.Id, CharacterName = "Tony Stark", Order = 1},
                    new MoviesActors(){MovieId = endgame.Id, PersonId = chrisEvans.Id, CharacterName = "Steve Rogers", Order = 2},
                    new MoviesActors(){MovieId = iw.Id, PersonId = robertDowney.Id, CharacterName = "Tony Stark", Order = 1},
                    new MoviesActors(){MovieId = iw.Id, PersonId = chrisEvans.Id, CharacterName = "Steve Rogers", Order = 2},
                    new MoviesActors(){MovieId = sonic.Id, PersonId = jimCarrey.Id, CharacterName = "Dr. Ivo Robotnik", Order = 1}
                });
        }
